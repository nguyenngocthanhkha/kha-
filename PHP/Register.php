...
<div class="container">
  ...
  <form action="../DATABASE/Registerdb.php" method="POST">
    ...
    <div><input type="text" name="full_name" placeholder="Họ tên" required></div>
    <div><input type="date" name="birth_date" required></div>
    ...
    <div><input type="tel" name="phone" placeholder="Số điện thoại" required pattern="^\d{10,15}$" title="Số điện thoại phải có từ 10 đến 15 chữ số"></div>
